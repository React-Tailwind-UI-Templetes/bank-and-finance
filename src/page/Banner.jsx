...
const Banner = () => {
  return (
    <div className="relative">
      <video
        src="https://www.shutterstock.com/shutterstock/videos/1055317610/preview/stock-footage-project-leader-and-chief-executive-discuss-data-shown-on-big-display-screens-show-infographics.webm"
        autoPlay
        muted
        ...
        <div className="px-4 py-10 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 md:py-16 text-white">
          ...
          <div className="">
            <p className="text-lg mb-4">
              <i>" Find Everything You Need Here "</i>
            </p>
