...
const Header = () => {
  ...
  return (
    <div className=" p-5 items-center bg-slate-300">
      <div className=" container mx-auto hidden lg:flex lg:justify-between max-w-full">
      <div className="p-4 text-2xl text-black font-semibold">React TailwindUi</div>
        <div>
          <div className="grid grid-cols-6 gap-4 text-xl font-semibold ">
